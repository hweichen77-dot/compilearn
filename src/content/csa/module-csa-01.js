  ...
  "lessons": [
    {
      ...
      "hints": [
        "Three values arrive in a row: a whole number, then a decimal number, then a true or false. Each one has to come back out unchanged, on a line of its own.",
        "Three variables, each declared with the type that matches the value it will hold, and three separate print calls that each finish their line.",
        "Skeleton: int n = sc.nextInt(); double d = ____; boolean b = sc.nextBoolean(); then println each one. The blank is the Scanner method named after the type it reads."
      ],
    ...
    },
    {
      ...
      "hints": [
        "Two whole numbers arrive, a width then a height. One number goes out: how many unit squares fit inside that rectangle.",
        "Two int variables holding the input, and a third that holds the two of them combined before anything is printed.",
        "Skeleton: int width = sc.nextInt(); int height = sc.nextInt(); int area = ____; println area. The blank is the operation that turns two side lengths into an area."
      ],
    ...
    },
    {
      ...
      "hints": [
        "Two whole numbers arrive. One line goes out: the word Sum, a colon and a space, then what the two numbers add up to.",
        "Two int variables, and one print call that puts fixed text and a computed number on the same line. What the + operator sees on its left decides whether it adds or joins text.",
        "Skeleton: read a and b as ints; then println(\"Sum: \" + ____). The blank has to be grouped so the numbers add before they meet the text."
      ],
    ...
    },
    {
      ...
      "hints": [
        "Two whole numbers arrive. What goes out is the point exactly halfway between them, and it keeps its decimal part even when the two do not split evenly.",
        "Two int variables, a double for the answer, and a division where at least one side is not an int so the fraction survives. The sum has to be formed before the split.",
        "Skeleton: read a and b as ints; double avg = (a + b) / ____; println avg. The blank is what stops the division from truncating."
      ],
    ...
    },
    {
      ...
      "hints": [
        "One number from 0 to 99 arrives. Two lines go out: the digit in the tens place first, then the digit in the ones place.",
        "Two int variables built from the same input value, one operator that keeps the whole part of a division by 10 and one that keeps what was left over.",
        "Skeleton: int n = sc.nextInt(); int tens = n / 10; int ones = n ____ 10; println tens then ones. The blank is the operator that returns the remainder."
      ],
    ...
    },
    {
      ...
      "hints": [
        "Three whole numbers arrive. One number goes out: the value of a fixed formula built from them, computed the way Java groups it rather than the way you read it aloud.",
        "Three int variables and one expression written exactly as the problem states it. No extra grouping is needed, precedence already does the grouping, and every division here is int division.",
        "Skeleton: read a, b, c as ints; int result = ____; println result. The blank is the formula copied straight from the problem, with nothing rearranged."
      ],
    ...
    },
    {
      ...
      "hints": [
        "Two whole numbers arrive, the points earned and the points possible. What goes out is the share earned, scaled to be out of 100, keeping its decimal part.",
        "Two int variables and one expression that turns the division into double division before it runs, then scales the result. The conversion has to happen to an operand, not to the finished quotient.",
        "Skeleton: read earned and total as ints; double percent = ____ / total * 100; println percent. The blank is the numerator with its type changed."
      ],
    ...
    },
    {
      ...
      "hints": [
        "Four whole numbers arrive one after another. One number goes out: what all four add up to together.",
        "A single variable that exists before any reading starts and survives across all four reads, updated once per number with the add-and-assign operator.",
        "Skeleton: int total = ____; then four lines of total += sc.nextInt(); then println total. The blank is the value a sum has to start from."
      ],
