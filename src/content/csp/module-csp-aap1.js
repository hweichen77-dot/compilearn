  ...
  "lessons": [
    {
      ...
      "hints": [
        "A count arrives first, then that many numbers on their own lines. One number comes out, the result of adding all of them together.",
        "You need a running total that already exists before the first number is read, and a repetition that happens exactly as many times as the count says.",
        "set the total to zero, then repeat that many times reading a number and ____, then print the total once at the end."
      ],
    ...
    },
    {
      ...
      "hints": [
        "A count arrives, then that many numbers on a single line. One number comes out, the biggest of them, and every number in the data may be negative.",
        "You need a running best that starts out as an actual element of the data rather than a made-up number, plus one pass across every value.",
        "set the best to the first value, then for each value if ____ make that value the new best, then print the best."
      ],
    ...
    },
    {
      ...
      "hints": [
        "One whole number of cents arrives. Two numbers come out inside a sentence: how many whole dollars that amount contains, and how many cents are left over.",
        "You need the whole-number part of dividing by one hundred, and separately the amount left behind by that same division. Two different operators, one input.",
        "read the cents, take the whole dollars from dividing by 100, take the leftover with ____, then print both inside the sentence."
      ],
    ...
    },
    {
      ...
      "hints": [
        "One line of text arrives. Two things come out: the same characters in the opposite order, then a count of how many of those characters are vowels, whatever their case.",
        "You need a reversed copy of the sequence, plus a counter and a walk over every character that treats an upper and lower case letter as the same letter.",
        "print the text in reverse order, set the count to zero, then for each character if ____ raise the count, then print the count."
      ],
    ...
    },
    {
      ...
      "hints": [
        "A count arrives, then that many numbers on one line, then one target number. What comes out is those numbers in their original order with every copy of the target gone, and the result may be empty.",
        "You need a second collection that starts out empty and only ever receives the values worth keeping, so the original is never changed while you walk it.",
        "start an empty collection, then for each value if ____ add it to the new collection, then print the new collection as one space-separated line."
      ],
    ...
    },
    {
      ...
      "hints": [
        "Two whole numbers arrive, a width and a height. Two numbers come out: the space the rectangle covers, then the distance all the way around its edge.",
        "You need two named blocks, each taking the same pair of incoming values and handing one number back, with all the printing done outside them.",
        "define one block that hands back width times height, define another that hands back ____, then read both numbers and print the result of calling each."
      ],
    ...
    },
    {
      ...
      "hints": [
        "Three whole numbers arrive on one line. One number comes out, the largest of the three, and all three of them may be negative.",
        "You need a running best seeded with one of the actual values, two comparisons against it, and a result handed back to the caller rather than shown from inside.",
        "set the best to the first value, then if the second beats it make it the best, then if the third beats it make it the best, then ____ the best."
      ],
    ...
    },
    {
      ...
      "hints": [
        "One positive whole number arrives. One line comes out: that number and every number below it down to one, in descending order, separated by single spaces.",
        "You need a piece of text built up inside a named block, from a count that steps downward, with the finished text handed back rather than shown from inside the block.",
        "inside the block start with empty text, then counting down from the start to 1 add each value and a space, then ____ the trimmed text."
      ],
