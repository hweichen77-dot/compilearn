  ...
  return (
    <section id="playground" style={{ borderBottom: "1px solid #111917", padding: "clamp(36px, 5vw, 60px) 2rem clamp(64px, 9vw, 120px)" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        ...
        <p style={{ fontFamily: mono, fontSize: "0.72rem", color: "rgba(255,255,255,0.82)", margin: "10px 0 0", lineHeight: 1.6 }}>
          Attacks run against a real AI language model. Output is generated by AI and can be wrong. Your
          prompt and the test inputs are sent to Groq to run it.
        </p>
