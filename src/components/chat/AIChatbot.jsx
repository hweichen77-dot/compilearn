...
export default function AIChatbot({ context = "", lessonTitle = "", lessonId = "", currentCode = "", lastOutput = "" }) {
  ...
  const defaultMessage = {
    role: "assistant",
    content: `You are chatting with an AI language model, not a person. It can be wrong, so check anything important against the lesson. Ask me anything about ${lessonTitle || "this lesson"}.`,
  };
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="sr-only">This assistant is an artificial intelligence, not a human.</span>
            ...
            <p
              className="px-5 py-2 font-sans text-xs flex-shrink-0"
              style={{ color: "#FFFFFF", background: "#0C1210", borderTop: "1px solid #17201C", lineHeight: 1.5, margin: 0 }}
            >
              AI responses are generated by a language model and can be inaccurate. Your question and code
              are sent to Groq to produce them.
            </p>
